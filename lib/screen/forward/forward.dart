...
import 'package:XLINXCHAT/screen/forward/forward_view_model.dart';
import 'package:XLINXCHAT/screen/forward/widgets/group_card.dart';
import 'package:XLINXCHAT/screen/forward/widgets/user_card.dart';
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (roomModel.isGroup) {
                        ...
                        return StreamBuilder<DocumentSnapshot>(
                          stream: userService
                              .getRoomUserStream(roomModel.membersId,prefs),
