...
import 'package:XLINXCHAT/screen/broadcast/chat_screen/widget/message_view/alert_message.dart';
import 'package:XLINXCHAT/screen/broadcast/chat_screen/widget/message_view/document_message.dart';
import 'package:XLINXCHAT/screen/broadcast/chat_screen/widget/message_view/image_message.dart';
import 'package:XLINXCHAT/screen/broadcast/chat_screen/widget/message_view/text_message.dart';
...
class MessageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool contains = selectedMessages
        ...
        .isNotEmpty;
    final bool sender = message.sender == Id;
